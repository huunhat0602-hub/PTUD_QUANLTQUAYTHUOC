...
public class FrmQuanLyNhanVien extends JFrame implements ActionListener, MouseListener {
	...
	public FrmQuanLyNhanVien() {
		...
		lblTenTK.setBounds(704, 147, 62, 25);
		panel.add(lblTenTK);
		...
		lblLoaiNV.setBounds(1011, 109, 62, 25);
		panel.add(lblLoaiNV);
		lblLoaiNV.setFont(new Font("Times New Roman", Font.PLAIN, 15));

		JLabel lblTen = new JLabel("Tên:");
		lblTen.setBounds(704, 75, 31, 25);
		panel.add(lblTen);
		...
		lblNgaySinh.setBounds(1011, 73, 62, 25);
		...
		lblDiaChi.setBounds(704, 181, 50, 25);
		panel.add(lblDiaChi);
